...
function App() {
  return (
    <div className="relative w-screen h-full bg-radial animate-radial">      
      ...
      <div className="relative z-10 flex flex-col gap-5 justify-center w-full h-full pt-40 px-10 lg:px-20 lg:px-25 lg:px-50 xl:px-85">      
        ...
        <div className="flex flex-row gap-5 mb-10 items-center justify-center sm:justify-start">
          ...
          <div className='flex flex-col'>
            <p className="cursor-pointer text-4xl lg:text-6xl hover:text-purple-600 dark:hover:text-purple-500 transition-colors duration-300">Isabel</p>
            <p className="cursor-pointer text-4xl lg:text-6xl hover:text-purple-500 dark:hover:text-purple-400 transition-colors duration-300">Hernández</p>
            <p className="cursor-pointer text-4xl lg:text-6xl hover:text-purple-400 dark:hover:text-purple-300 transition-colors duration-300">Barrio</p>
          </div>
        </div>
        <p>
        ...
        <div className='flex flex-col gap-30'>
          ...
          <div className='flex flex-col gap-5'>
            <h1 className='text-center lg:text-left'>&lt;Education&#47;&gt;</h1>
          ...
          {/* Experience */}
          <div className='flex flex-col gap-5'>
            <h1 className='text-center lg:text-left'>&gt;_Experience</h1>
          ...
          {/* Projects */}
          <div className='flex flex-col gap-5'>
            <h1 className='text-center lg:text-left'>&lt;Projects&#47;&gt;</h1>
          ...
          <div className='flex flex-col gap-10'>
            ...
            <div className='flex flex-col lg:flex-row lg:flex-row gap-5'>
                ...
                <img className='order-1 lg:order-2 shadow-2xl w-full lg:w-100 h-full h-max-100 lg:h-70 rounded-lg bg-gray-900 rounded-lg cursor-pointer object-cover' src='/letterex.png'
                />
            </div>
...
const TechTag = ( { tech }: TagProps ) => {
  ...
  return (
    <div className='w-fit bg-[#23272F]/20 dark:bg-[#23272F]/70 px-2 py-1 rounded-full flex flex-row gap-1 items-center'>
...
const Contact = () => {
  return (
    <div className='w-full justify-center my-10 flex flex-wrap gap-2'>
      <button className="text-xs md:text-md rounded-full p-1 bg-opacity-0 border border-1 border-purple-300 dark:border-white w-fit flex flex-row gap-1 items-center"
      onClick={() => window.open("https://github.com/isalamajor/", "_blank")}>
        <Github/>
        <p>Github</p>
      </button>
      
      <button className="rounded-full bg-opacity-0 border border-1 border-purple-300 dark:border-white w-fit flex flex-row gap-1 items-center"
      onClick={() => window.open("https://www.linkedin.com/in/isabel-hernández-barrio-408a38326", "_blank")}>
        <Linkedin/>
        LinkedIn
      </button>
      
      <button className="rounded-full p-1 bg-opacity-0 border border-1 border-purple-300 dark:border-white w-fit flex flex-row gap-1 items-center"
